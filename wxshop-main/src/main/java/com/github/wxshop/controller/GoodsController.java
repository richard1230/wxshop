...
public class GoodsController {
     ...
     *     "totalPage": 5, "data": [ { "id": 12345, "name": "肥皂", "description": "纯天然无污染肥皂",
     *     "details": "这是一块好肥皂", "imgUrl": "https://img.url", "price": 500, "stock": 10, "shopId":
     *     12345, "createdAt": "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" }, { ... }
     *     ] }
     ...
     * @apiSuccessExample Success-Response: HTTP/1.1 200 OK { "data": { "id": 12345, "name": "肥皂",
     *     "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl": "https://img.url", "price": 500,
     *     "stock": 10, "shopId": 12345, "createdAt": "2020-03-22T13:22:03Z", "updatedAt":
     *     "2020-03-22T13:22:03Z" } }
     ...
     * @apiParamExample {json} Request-Example: { "name": "肥皂", "description": "纯天然无污染肥皂", "details":
     *     "这是一块好肥皂", "imgUrl": "https://img.url", "price": 500, "stock": 10, "shopId": 12345 }
     * @apiSuccess {Goods} data 创建的商品
     * @apiSuccessExample Success-Response: HTTP/1.1 201 Created { "data": { "id": 12345, "name":
     *     "肥皂", "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl": "https://img.url",
     *     "price": 500, "stock": 10, "shopId": 12345, "createdAt": "2020-03-22T13:22:03Z",
     ...
     * @apiParamExample {json} Request-Example: { "name": "肥皂", "description": "纯天然无污染肥皂", "details":
     *     "这是一块好肥皂", "imgUrl": "https://img.url", "price": 500, "stock": 10 }
     * @apiSuccess {Goods} data 更新后的商品
     * @apiSuccessExample Success-Response: HTTP/1.1 200 OK { "data": { "id": 12345, "name": "肥皂",
     *     "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl": "https://img.url", "price": 500,
     *     "stock": 10, "createdAt": "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" } }
     * @apiError 400 Bad Request 若用户的请求中包含错误
     * @apiError 401 Unauthorized 若用户未登录
     ...
     * @apiSuccessExample Success-Response: HTTP/1.1 204 No Content { "data": { "id": 12345, "name":
     *     "肥皂", "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl": "https://img.url",
     *     "price": 500, "stock": 10, "createdAt": "2020-03-22T13:22:03Z", "updatedAt":
     *     "2020-03-22T13:22:03Z" } }
     * @apiError 400 Bad Request 若用户的请求中包含错误
     * @apiError 401 Unauthorized 若用户未登录
    ...
    public Response<Goods> deleteGoods(
            @PathVariable("id") Long goodsId, HttpServletResponse response) {
