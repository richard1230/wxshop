...
public class OrderController {
     ...
     * @apiParam {String=pending/paid/delivered/received} [status] 订单状态：pending 待付款 paid 已付款 delivered
     *     物流中 received 已收货
     ...
     * @apiSuccessExample Success-Response: HTTP/1.1 200 OK { "pageNum": 1, "pageSize": 10,
     *     "totalPage": 5, "data": [ { "id": 12345, "expressCompany": null, "expressId": null,
     *     "status": "pending", "totalPrice": 10000, "address": "XXX", "shop": { "id": 12345, "name":
     *     "我的店铺", "description": "我的苹果专卖店", "imgUrl": "https://img.url", "ownerUserId": 12345,
     *     "createdAt": "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" }, "goods": [ {
     *     "id": 12345, "name": "肥皂", "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl":
     *     "https://img.url", "address": "XXX", "price": 500, "number": 10, "createdAt":
     *     "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" }, { ... } ] }, { ... } ] }
    ...
    public PageResponse<OrderResponse> getOrder(
        ...
        return orderService.getOrder(
                UserContext.getCurrentUser().getId(), pageNum, pageSize, DataStatus.fromStatus(status));
    }
     ...
     * @apiParamExample {json} Request-Example: { "goods": [ { "id": 12345, "number": 10, }, { ... } }
     * @apiSuccess {Order} data 刚刚创建完成的订单
     * @apiSuccessExample Success-Response: HTTP/1.1 201 Created { "data": { "id": 12345,
     *     "expressCompany": null, "expressId": null, "status": "pending", "address": "XXX", "shop": {
     *     "id": 12345, "name": "我的店铺", "description": "我的苹果专卖店", "imgUrl": "https://img.url",
     *     "ownerUserId": 12345, "createdAt": "2020-03-22T13:22:03Z", "updatedAt":
     *     "2020-03-22T13:22:03Z" }, "goods": [ { "id": 12345, "name": "肥皂", "description":
     *     "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl": "https://img.url", "address": "XXX", "price":
     *     500, "number": 10, "createdAt": "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z"
     *     }, { ... } ] } }
     * @apiError 400 Bad Request 若用户的请求中包含错误
     * @apiError 401 Unauthorized 若用户未登录
     * @apiError 404 Not Found 若商品未找到
     * @apiErrorExample Error-Response: HTTP/1.1 400 Bad Request { "message": "商品已经售完" }
     */
    /**
     ...
     * @apiParamExample {json} Request-Example: { "id": 12345, "expressCompany": "圆通", "expressId":
     *     "YTO1234", } { "id": 12345, "status": "RECEIVED" }
     * @apiSuccess {Order} data 更新后的订单
     * @apiSuccessExample Success-Response: HTTP/1.1 200 OK { "data": { "id": 12345, "expressCompany":
     *     null, "expressId": null, "status": "pending", "address": "XXX", "shop": { "id": 12345,
     *     "name": "我的店铺", "description": "我的苹果专卖店", "imgUrl": "https://img.url", "ownerUserId":
     *     12345, "createdAt": "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" }, "goods":
     *     [ { "id": 12345, "name": "肥皂", "description": "纯天然无污染肥皂", "details": "这是一块好肥皂", "imgUrl":
     *     "https://img.url", "address": "XXX", "price": 500, "number": 10, "createdAt":
     *     "2020-03-22T13:22:03Z", "updatedAt": "2020-03-22T13:22:03Z" }, { ... } ] } }
     * @apiError 400 Bad Request 若用户的请求中包含错误
     ...
     * @apiErrorExample Error-Response: HTTP/1.1 404 Not Found { "message": "Not Found" }
     */
    /**
     * 更新订单
     *
     ...
     * @apiSuccessExample Success-Response: HTTP/1.1 204 No Content { "data": { "id": 12345,
     *     "expressCompany": null, "expressId": null, "status": "pending", "address": "XXX", "shop": {
     *     "id": 12345, "name": "我的店铺", "description": "我的苹果专卖店", "imgUrl": "https://img.url",
     *     "ownerUserId": 12345, "createdAt": "2020-03-22T13:22:03Z", "updatedAt":
     *     "2020-03-22T13:22:03Z" }, "goods": [ { "id": 12345, "name": "肥皂", "description":
